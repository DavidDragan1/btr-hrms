import { IActivityWatchAfkEvent, IActivityWatchBucket, IActivityWatchWebEvent, IActivityWatchWindowEvent, IDateRange } from '@gauzy/contracts';
...
//# sourceMappingURL=i-activity-watch.d.ts.map